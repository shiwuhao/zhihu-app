                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('setting') }}">
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input  type="text" class="form-control" name="city" value="{{ user()->settings['city'] }}" required>
                                    @if ($errors->has('city'))
                            ...
                            <div class="form-group{{ $errors->has('bio') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea  class="form-control" name="bio" required>{{ user()->settings['bio'] }}</textarea>
                                    @if ($errors->has('bio'))
                                        <span class="help-block">
